  ...
  <div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div v-if="store.items.test_module.list.length > 0">
          <div class="table-responsive">
            ...
            <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
              ...
              <tbody class="fw-semibold text-gray-600">
                <tr
                  v-for="(item, i) in store.items.test_module.list"
                  :key="'item_' + i"
                >
                  <!--begin::Checkbox-->
                  <td>
                      ...
                      >
                        ...
                        <li class="menu-item">
                          <a
                            href="#"
                            class="menu-link px-3"
                            @click="deleteTestModule(item, item.id)"
                            >Eliminar</a
                          >
                        </li>
                      </ul>
...
const deleteTestModule = (item, id) => {
  store.setSelectedItem("test_module", item);
  confirm(swal, "¿Está seguro que desea eliminar este elemento?", () => {
    store.deleteTestModule(id);
  });
};
...
const checkUncheckAll = (v) => {
  if (v.target.checked) {
    ...
    store.items.test_module.list.map((item) => {
...
const onChangePage = (a) => {
  ...
  store.setTestModuleList();
};
let items_per_page = ref(store.items.test_module.paginator.items_per_page);
...
const createTestModule = () => {
  store.setModal("create_test_module");
  store.setModalTitle("Agregar test_module");
  store.setFormMode("create_update_test_module", "create");
};
const seeTestModule = (item, index) => {
  store.setModal("see_test_module");
  store.setModalTitle("Ver datos de test_module");
  store.setFormMode("create_update_test_module", "see");
  store.setSelectedItem("test_module", item);
  store.setSelectedItemIndex("test_module", index);
};

const updateTestModule = (item, index) => {
  store.setModal("update_test_module");
  store.setModalTitle("Editar test_module");
  store.setFormMode("create_update_test_module", "update");
  store.setSelectedItem("test_module", item);
  store.setSelectedItemIndex("test_module", index);
};

const closeTestModuleModal = () => {
  store.setModal("");
  store.setModalTitle("");
  store.setFormMode("create_update_test_module", "");
  store.setSelectedItem("test_module", {});
  store.setSelectedItemIndex("test_module", -1);
};
onMounted(() => {
