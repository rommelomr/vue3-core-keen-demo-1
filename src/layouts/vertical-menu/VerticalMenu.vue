                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <!--end:Row-->
                      <div
                        class="separator separator-dashed mx-lg-5 my-4"
                      ></div>
                      <!--begin:Landing-->
                      <div
                        class="
                    ...
                    >
                      ...
                      <div class="py-3 text-center border-top">
                        <a
                          href="../../demo1/dist/pages/user-profile/activity.html"
                          class="
                            btn btn-color-gray-600 btn-active-color-primary
                          "
                          >View All
        ...
        >
          ...
          <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
            ...
            >
              ...
              >
                <div
                  v-for="(level_one_option, i) in options"
                  :key="'level_one_option_' + i"
                  data-kt-menu-trigger="click"
                  class="menu-item menu-accordion"
                >
                  <span class="menu-link" @click="redirect(level_one_option)">
                    <span class="menu-bullet">
                      <span class="bullet bullet-dot"></span>
                    </span>
                    <span class="menu-title">{{ level_one_option.title }}</span>
                    <span
                      v-if="level_one_option.items"
                      class="menu-arrow"
                    ></span>
                  </span>
                  <div
                  ...
                  >
                    <div
                      v-for="(level_two_option, j) in level_one_option.items"
                      :key="'level_two_option' + j"
                      data-kt-menu-trigger="click"
                      class="menu-item"
                      :class="[level_two_option.items && 'menu-accordion']"
                    >
                      <!--begin:Menu link-->
                      <a class="menu-link" @click="redirect(level_two_option)">
                        <span class="menu-bullet">
                          <span class="bullet bullet-dot"></span>
                        </span>
                        <span class="menu-title">{{
                          level_two_option.title
                        }}</span>
                        <span
                          v-if="level_two_option.items"
                          class="menu-arrow"
                        ></span>
                      </a>
                      ...
                      >
                        <div
                          v-for="(
                            level_three_option, k
                          ) in level_two_option.items"
                          :key="'level_three_option_' + k"
                          class="menu-item"
                        >
                          <a
                            class="menu-link"
                            @click="redirect(level_three_option)"
                          >
                            <span class="menu-bullet">
                              <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">{{
                              level_three_option.title
                            }}</span>
                          </a>
                        </div>
                      </div>
                ...
                <div
                  v-for="(level_one_option, i) in HelpOptions"
                  :key="'level_one_option_' + i"
                  data-kt-menu-trigger="click"
                  class="menu-item menu-accordion"
                >
          ...
          <div class="d-flex flex-column me-3">
            ...
            <div class="d-flex align-items-center">
              ...
              <a
                href="#"
                class="
                  btn btn-sm btn-light-success btn-icon-success btn-icon
                  w-25px
                  h-25px
                  me-2
                "
...
import Options, { HelpOptions } from "../options.js";
...
const redirect = (option) => {
  if (option.items == undefined) {
    router.push({ name: option.route_name });
  }
};
const logOut = () => {
  auth.logOut();
